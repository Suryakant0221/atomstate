...
$(document).ready(function () {
  // Function to continuously scroll the client section horizontally
  function autoScroll() {
    var scrollSpeed = 20; // Adjust scroll speed as needed
    var $clientSection = $(".client-section");

    // Check if there is enough content to scroll
    if ($clientSection[0].scrollWidth > $clientSection.innerWidth()) {
      $clientSection.animate(
        {
          scrollLeft: $clientSection.scrollLeft() + 1,
        },
        scrollSpeed,
        "linear",
        function () {
          ...
          if (
            $clientSection.scrollLeft() >=
            $clientSection[0].scrollWidth - $clientSection.innerWidth()
          ) {
            $clientSection.scrollLeft(0);
          }
        }
      );
    }
  ...
  // Call autoScroll function every 50 milliseconds (adjust interval as needed)
